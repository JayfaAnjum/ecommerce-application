...
export const userOrders = async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`${process.env.REACT_APP_API_URL}/api/v1/myorders`,{withCredentials: true})
...
export const orderDetail = id => async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`${process.env.REACT_APP_API_URL}/api/v1/order/${id}`,{withCredentials: true})
...
export const deleteOrder = id => async(dispatch) => {
    try {
       ...
       await axios.delete(`${process.env.REACT_APP_API_URL}/api/v1/admin/order/${id}`,{withCredentials: true})
...
export const updateOrder = (id, orderData)  => async(dispatch) => {
    try {
       ...
       const { data} = await axios.put(`${process.env.REACT_APP_API_URL}/api/v1/admin/order/${id}`, orderData, {withCredentials: true})
